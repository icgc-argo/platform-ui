...
import { isRdpcMember, isDccMember, canReadSomeProgram } from 'global/utils/egoJwt';
...
export default createPage({
  isPublic: false,
  isAccessible: async ({ egoJwt, ctx }) => !isRdpcMember(egoJwt) && canReadSomeProgram(egoJwt),
