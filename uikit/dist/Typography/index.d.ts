...
declare const createStyledDomComponent: ((
  Component: any,
) => import('@emotion/styled-base').StyledComponent<
...
export declare type TypographyVariant = keyof typeof defaultTheme.typography;
