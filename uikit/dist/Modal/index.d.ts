...
export declare const ModalContainer: import('@emotion/styled-base').StyledComponent<
 ...
 */
declare const ModalComponent: React.ComponentType<{
...
declare const Overlay: (props: any) => JSX.Element;
